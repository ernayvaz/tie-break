...
const ACTION_LABELS: Record<string, string> = {
  ...
  halisaha_match_updated: "Halisaha match updated",
  halisaha_match_archived: "Halisaha match archived",
  halisaha_match_archive_purged: "Halisaha archive purged",
  halisaha_participant_added: "Halisaha participant added",
  halisaha_guest_added: "Halisaha guest added",
  halisaha_participant_updated: "Halisaha participant updated",
  halisaha_participant_removed: "Halisaha participant removed",
  halisaha_question_created: "Halisaha question created",
  halisaha_question_updated: "Halisaha question updated",
  halisaha_question_deleted: "Halisaha question deleted",
  halisaha_question_resolved_option: "Halisaha correct answer updated",
  halisaha_answers_scored: "Halisaha answers scored",
