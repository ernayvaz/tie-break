  ...
  return (
    <div>
      ...
      <p className="mt-2 text-sm text-nord-polarLight">
        Resync matches/results (World Cup via OpenLigaDB, plus football-data.org when available) and highlights (Champions League stored clips; official World Cup recaps stream live from the embedded highlights widget). After match sync, scores and leaderboard are recalculated automatically. Manual result entry is in{" "}
      ...
      <div className="mt-6 space-y-6">
        ...
        <Card>
          <CardContent className="py-6">
            ...
            <p className="text-sm text-nord-polarLight mb-4">
              Fetch Champions League video highlights (embeddable, on-site playback). Official World Cup highlights stream live from the embedded widget on the highlights page.
            </p>
