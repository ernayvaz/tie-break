...
export default async function AdminPowerPickPage() {
  ...
  return (
    <div>
      <h1 className="text-xl font-semibold text-nord-polar">Power Pick points</h1>
      <p className="mt-2 max-w-3xl text-sm text-nord-polarLight">
        Manage World Cup Power Pick boosters. Each package grants{" "}
        <strong>{POWER_PICK_PACKAGE_SIZE}</strong> rights and can be assigned as direct 1-10 point
        values. Choose any amount up to{" "}
