  ...
  return (
    <article className="overflow-hidden rounded-[1.8rem] border border-white/70 bg-[linear-gradient(135deg,rgba(46,52,64,0.98),rgba(59,66,82,0.94),rgba(76,86,106,0.9))] text-white shadow-[0_32px_90px_rgba(46,52,64,0.18)]">
      <div className="grid gap-0 lg:grid-cols-[minmax(0,1.15fr)_minmax(22rem,0.85fr)]">
        <div className="relative min-h-[18rem] overflow-hidden">
          {highlight.thumbnailUrl ? (
            <>
              ...
              />
              <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(46,52,64,0.28),rgba(46,52,64,0.58),rgba(46,52,64,0.82))]" />
            </>
          ) : (
        ...
        <div className="flex flex-col justify-between bg-white/10 px-5 py-5 backdrop-blur-sm sm:px-7 sm:py-6">
          <div>
